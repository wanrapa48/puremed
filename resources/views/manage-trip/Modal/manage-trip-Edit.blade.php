<div class="modal fade" id="modal-managetrip-Edit">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">แก้ไขข้อมูลทริป</h5>
      </div>
      <div class="modal-body">
        ...
        <p class="profiletext">รูปภาพ</p>
          <div class="container">
            <img src="{{asset('storage/img/trip/img-1.png')}}" style="width: 200px;">
            <button ng-click="Deletephoto('img-1.png')" class="delete-photo">
              <i><img src="{{asset('storage/img/icon/cancelphoto.png')}}"></i>
            </button>
          </div>
          <div class="container">
            <img src="{{asset('storage/img/trip/img-2.png')}}" style="width: 200px;">
            <button ng-click="Deletephoto('img-2.png')" class="delete-photo">
              <i><img src="{{asset('storage/img/icon/cancelphoto.png')}}"></i>
            </button>
          </div>
